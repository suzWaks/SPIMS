        ...
        child: Padding(
          ...
          child: Column(
            children: <Widget>[
              ...
              Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween, // Adjust spacing as needed
                children: <Widget>[
                  ElevatedButton(
                    onPressed: () {
                ...
                child: const Center(
                  child: Row(
                    ...
                    children: <Widget>[
                      ...
                      SizedBox(width: 8), // Add spacing between the "+" sign and "Add" text
                      Text(
                        'Add',
                        style: TextStyle(
                          color: Colors.orange,
              ...
              const SizedBox(height: 20), // Add spacing between the buttons and the next row
